...
namespace ServiceBus.ChatApp
{
    class Program
    {
        const string SendServiceBusConnectionString = "<Enter the Service Bus connection string>";
        const string SendQueueName = "allmessages";
        static IQueueClient sendQueueClient;

        const string ReceiveServiceBusConnectionString = "<Enter the Service Bus connection string>";
        const string ReceiveQueueName = "filteredmessages";
