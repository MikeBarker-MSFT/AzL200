...
namespace CustomerApiFunctions
{
    public static class CustomersAPI
    {
            ...
            ExecutionContext context)
        {
            ...
            var executor = new SqlExecutor(config);
            int id = await executor.Execute<int>(commandText);
            ...
            ExecutionContext context)
        {
            ...
            var executor = new SqlExecutor(config);
            await executor.Execute(commandText);
            ...
            ExecutionContext context)
        {
            ...
            /* Ref: Adams, Douglas (1981). The Hitchhiker's Guide to the Galaxy */
            if (customerId == 42)
                throw new ArgumentOutOfRangeException("42 can not be deleted because it is the Answer to the Ultimate Question of Life, the Universe, and Everything.");
